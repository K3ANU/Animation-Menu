...
RegisterKeyMapping(config.openCommand, 'weapons Customer', 'keyboard', 'home')
...
RegisterNUICallback("4", function(data)
    ...
    TriggerEvent("esx:showNotification", "In Animation Dar Hal Hazer Off Ast!")
    -- HolsterAnim = GetResourceKvpString("HolsterAnim")
    SetDisplay(false)
end)
